...
const createRole = async () => {
    ...
    try {
        ...
        if (error.response?.data?.errors) {
            ...
            errorMessage.value = 'Failed to creaate role'
        }
    } finally {
    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="container mx-auto px-4 max-w-5xl">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-500 mt-1">Create role information and permissions</p>
            </div>
            ...
            <div>
                ...
                <!-- Form -->
                <form @submit.prevent="createRole" class="bg-white rounded-xl shadow-lg overflow-hidden">
